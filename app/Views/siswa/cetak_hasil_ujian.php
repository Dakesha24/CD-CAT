        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="info-box">
                    ...
                    <div class="info-value"><?= date('d M Y H:i', strtotime($hasil['waktu_mulai'])) ?></div>
                    
                    <div class="info-label">Waktu Selesai:</div>
                    <div class="info-value"><?= date('d M Y H:i', strtotime($hasil['waktu_selesai'])) ?></div>
                    
                    <div class="info-label">Total Waktu:</div>
                    <div class="info-value"><?= date('H:i:s', strtotime($hasil['waktu_selesai']) - strtotime($hasil['waktu_mulai'])) ?></div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><strong><?= number_format($jawabanBenar / $totalSoal * 100, 1) ?>%</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="pembahasan-container">
            ...
            <?php foreach ($detailJawaban as $i => $jawaban): ?>
                ...
                <div class="pembahasan-item">
                    <div class="fw-bold mb-2">Soal #<?= $i + 1 ?>:</div>
