...
<script>
    ...
    function onKategoriChange() {
        ...
        fetch(`<?= base_url('admin/bank-soal/api/jenis-ujian') ?>?kategori=${encodeURIComponent(kategori)}`)
            .then(response => response.json())
            .then(data => {
                if (data.status === 'success') {
    ...
    function onJenisUjianChange() {
        ...
        // Load bank ujian
        fetch(`<?= base_url('admin/bank-soal/api/bank-ujian') ?>?kategori=${encodeURIComponent(kategori)}&jenis_ujian_id=${jenisUjianId}`)
            .then(response => response.json())
            .then(data => {
                if (data.status === 'success') {
    ...
    function onBankUjianChange() {
        ...
        fetch(`<?= base_url('admin/bank-soal/api/soal') ?>?bank_ujian_id=${bankUjianId}`)
            .then(response => response.json())
            .then(data => {
                if (data.status === 'success') {
